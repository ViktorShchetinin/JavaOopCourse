...
public class Main {
       public static Shape getMaximumShapeArea(Shape[] shapesArray) {
        Arrays.sort(shapesArray, new AreaComparator());
        return shapesArray[shapesArray.length - 1];
    }

    public static Shape getSecondShapePerimeter(Shape[] shapesArray) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат сравнения двух квадратов " + square + " и " + square1 + ": " + square.equals(square1));
        ...
        System.out.println("Максимальная фигура по площади: " + getMaximumShapeArea(shapesArray));
        System.out.println();
        ...
        System.out.println("Вторая фигура по периметру: " + getSecondShapePerimeter(shapesArray));
    }
}